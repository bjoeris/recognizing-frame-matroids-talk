    ...
    [ wideOverlayParent
      ...
      , fadeIn' i2 $ overlay
        [ p []
          [ text "A "
          , emph "frame matroid "
          , text "is a matroid with a frame matrix representation."
          ]
        ]
      ]
    , overlayParent
...
bicircular = do
  ...
  slide
    ...
    , p_ "$X\\subseteq E$ indepedent $\\Leftrightarrow$ each component of $G[X]$ has at most one cycle"
    , wideOverlayParent
...
biasedGraphs = do
  ...
  slide
    ...
    , wideOverlayParent
      [ fadeOut' i1 $ overlay
        [ p []
          [ text "A graph together with a family of "
          , redText "unbalanced"
          , text " cycles"
          ]
        ]
      , fadeInOut' i1 j1 $ p []
        [ lemma
          ...
          , ul []
            [ li [] [text "$M(A)=FM(G,\\Psi)$, for some $\\Psi$,"]
